...
public class MeasureController {
	...
	public ResponseEntity<Measure> createMeasure (@RequestPart MeasureCreationRequest request, @RequestPart MultipartFile file) {
	    return ResponseEntity.ok(measureService.createMeasure(request, file));
	}
